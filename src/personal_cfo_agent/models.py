...
class WarningCode(str, Enum):
    ...
    WEBULL_CONFIG_MISSING = "WEBULL_CONFIG_MISSING"
    WEBULL_SDK_NOT_INSTALLED = "WEBULL_SDK_NOT_INSTALLED"
    WEBULL_CLIENT_INIT_FAILED = "WEBULL_CLIENT_INIT_FAILED"
    WEBULL_AUTH_FAILED = "WEBULL_AUTH_FAILED"
    WEBULL_ACCOUNT_QUERY_FAILED = "WEBULL_ACCOUNT_QUERY_FAILED"
    WEBULL_ACCOUNT_LIST_QUERY_ATTEMPTED = "WEBULL_ACCOUNT_LIST_QUERY_ATTEMPTED"
    WEBULL_ACCOUNT_LIST_QUERY_OK = "WEBULL_ACCOUNT_LIST_QUERY_OK"
    WEBULL_ACCOUNT_LIST_EMPTY = "WEBULL_ACCOUNT_LIST_EMPTY"
    WEBULL_ACCOUNT_LIST_METHOD_MISSING = "WEBULL_ACCOUNT_LIST_METHOD_MISSING"
    WEBULL_ACCOUNT_QUERY_AUTH_FAILED = "WEBULL_ACCOUNT_QUERY_AUTH_FAILED"
    WEBULL_ACCOUNT_QUERY_PERMISSION_DENIED = "WEBULL_ACCOUNT_QUERY_PERMISSION_DENIED"
    WEBULL_ACCOUNT_QUERY_ENDPOINT_FAILED = "WEBULL_ACCOUNT_QUERY_ENDPOINT_FAILED"
    WEBULL_ACCOUNT_SELECTOR_MISMATCH = "WEBULL_ACCOUNT_SELECTOR_MISMATCH"
    WEBULL_ACCOUNT_QUERY_EXCEPTION_SANITIZED = (
        "WEBULL_ACCOUNT_QUERY_EXCEPTION_SANITIZED"
    )
    WEBULL_ASSET_QUERY_SKIPPED = "WEBULL_ASSET_QUERY_SKIPPED"
    WEBULL_POSITION_QUERY_SKIPPED = "WEBULL_POSITION_QUERY_SKIPPED"
    WEBULL_TOKEN_PREFLIGHT_ATTEMPTED = "WEBULL_TOKEN_PREFLIGHT_ATTEMPTED"
    WEBULL_TOKEN_STATUS_NORMAL = "WEBULL_TOKEN_STATUS_NORMAL"
    WEBULL_TOKEN_STATUS_PENDING = "WEBULL_TOKEN_STATUS_PENDING"
    WEBULL_TOKEN_STATUS_INVALID = "WEBULL_TOKEN_STATUS_INVALID"
    WEBULL_TOKEN_STATUS_EXPIRED = "WEBULL_TOKEN_STATUS_EXPIRED"
    WEBULL_TOKEN_STATUS_UNKNOWN = "WEBULL_TOKEN_STATUS_UNKNOWN"
    WEBULL_TOKEN_VERIFICATION_REQUIRED = "WEBULL_TOKEN_VERIFICATION_REQUIRED"
    WEBULL_ACCOUNT_PERMISSION_UNKNOWN = "WEBULL_ACCOUNT_PERMISSION_UNKNOWN"
    WEBULL_ACCOUNT_PERMISSION_DENIED = "WEBULL_ACCOUNT_PERMISSION_DENIED"
    WEBULL_ACCOUNT_QUERY_BLOCKED_BY_TOKEN = "WEBULL_ACCOUNT_QUERY_BLOCKED_BY_TOKEN"
    WEBULL_ACCOUNT_QUERY_BLOCKED_BY_PERMISSION = (
        "WEBULL_ACCOUNT_QUERY_BLOCKED_BY_PERMISSION"
    )
    WEBULL_ASSET_QUERY_FAILED = "WEBULL_ASSET_QUERY_FAILED"
    WEBULL_POSITION_QUERY_FAILED = "WEBULL_POSITION_QUERY_FAILED"
    WEBULL_NO_DATA_RETURNED = "WEBULL_NO_DATA_RETURNED"
    WEBULL_READ_ONLY_FETCH_OK = "WEBULL_READ_ONLY_FETCH_OK"
    WEBULL_LIVE_READ_SUCCEEDED = "WEBULL_LIVE_READ_SUCCEEDED"
    WEBULL_LIVE_READ_FAILED = "WEBULL_LIVE_READ_FAILED"
